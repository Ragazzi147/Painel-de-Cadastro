💻 Guia do Componente: Gerenciamento de Produtos
...
Tabela: Abaixo, uma tabela (<table>) exibe a lista de produtos. Ela usa a diretiva *ngFor para iterar sobre o array vetor e renderizar uma linha para cada produto. O botão "Selecionar" em cada linha ativa o método selecionarProduto(indice), preenchendo o formulário com os dados daquele item.
...
3. Seleção e Edição de um Produto
